...
clean:
	rm -f hashmin hashmin_combiner hashmin_combiner_spinlock hashmin_combiner_single_broadcast pagerank pagerank_combiner pagerank_combiner_spinlock pagerank_combiner_single_broadcast mirror_combiner
