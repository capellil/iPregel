...
sssp$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_UNUSED_IN_NEIGHBOURS):
	gcc -o $(BIN_DIRECTORY)/sssp$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_UNUSED_IN_NEIGHBOURS) $(BENCHMARKS_DIRECTORY)/sssp.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_MUTEX) $(DEFINES_UNUSED_IN_NEIGHBOURS) $(CFLAGS)
...
sssp$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_UNUSED_IN_NEIGHBOURS):
	gcc -o $(BIN_DIRECTORY)/sssp$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_UNUSED_IN_NEIGHBOURS) $(BENCHMARKS_DIRECTORY)/sssp.c -I$(SRC_DIRECTORY) -std=gnu99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SPINLOCK) $(DEFINES_UNUSED_IN_NEIGHBOURS) $(CFLAGS)
...
sssp$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_SPREAD)$(SUFFIX_UNUSED_IN_NEIGHBOURS):
	gcc -o $(BIN_DIRECTORY)/sssp$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_SPREAD)$(SUFFIX_UNUSED_IN_NEIGHBOURS) $(BENCHMARKS_DIRECTORY)/sssp.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_MUTEX) $(DEFINES_SPREAD) $(DEFINES_UNUSED_IN_NEIGHBOURS) $(CFLAGS)
...
sssp$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_SPREAD)$(SUFFIX_UNUSED_IN_NEIGHBOURS):
	gcc -o $(BIN_DIRECTORY)/sssp$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_SPREAD)$(SUFFIX_UNUSED_IN_NEIGHBOURS) $(BENCHMARKS_DIRECTORY)/sssp.c -I$(SRC_DIRECTORY) -std=gnu99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SPINLOCK) $(DEFINES_SPREAD) $(DEFINES_UNUSED_IN_NEIGHBOURS) $(CFLAGS)
...
all_sssp: scc$(SUFFIX_NO_COMBINER) \
		  ...
		  scc$(SUFFIX_COMBINER)$(SUFFIX_SPREAD)$(SUFFIX_SINGLE_BROADCAST) \
		  scc$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_SPREAD) \
		  scc$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_SPREAD)

scc$(SUFFIX_NO_COMBINER):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_NO_COMBINER) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_MUTEX):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_MUTEX) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_MUTEX) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=gnu99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SPINLOCK) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_SINGLE_BROADCAST):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_SINGLE_BROADCAST) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SINGLE_BROADCAST) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_SPREAD)$(SUFFIX_SINGLE_BROADCAST):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_SPREAD)$(SUFFIX_SINGLE_BROADCAST) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SPREAD) $(DEFINES_SINGLE_BROADCAST) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_SPREAD):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_MUTEX)$(SUFFIX_SPREAD) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=c99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_MUTEX) $(DEFINES_SPREAD) $(CFLAGS)

scc$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_SPREAD):
	gcc -o $(BIN_DIRECTORY)/scc$(SUFFIX_COMBINER)$(SUFFIX_SPINLOCK)$(SUFFIX_SPREAD) $(BENCHMARKS_DIRECTORY)/scc.c -I$(SRC_DIRECTORY) -std=gnu99 $(DEFINES) $(DEFINES_COMBINER) $(DEFINES_SPINLOCK) $(DEFINES_SPREAD) $(CFLAGS)
