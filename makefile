...
$(BIN_DIRECTORY)/cc: $(BENCHMARKS_DIRECTORY)/cc.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(CFLAGS)

$(BIN_DIRECTORY)/cc$(SUFFIX_SPREAD): $(BENCHMARKS_DIRECTORY)/cc.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(DEFINES_SPREAD) $(CFLAGS)

$(BIN_DIRECTORY)/cc$(SUFFIX_SINGLE_BROADCAST): $(BENCHMARKS_DIRECTORY)/cc.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(DEFINES_SINGLE_BROADCAST) $(CFLAGS)

$(BIN_DIRECTORY)/cc$(SUFFIX_SINGLE_BROADCAST)$(SUFFIX_SPREAD): $(BENCHMARKS_DIRECTORY)/cc.c
...
$(BIN_DIRECTORY)/pagerank: $(BENCHMARKS_DIRECTORY)/pagerank.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(CFLAGS)

$(BIN_DIRECTORY)/pagerank$(SUFFIX_SINGLE_BROADCAST): $(BENCHMARKS_DIRECTORY)/pagerank.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(DEFINES_SINGLE_BROADCAST) $(CFLAGS)
...
$(BIN_DIRECTORY)/sssp: $(BENCHMARKS_DIRECTORY)/sssp.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(CFLAGS)

$(BIN_DIRECTORY)/sssp$(SUFFIX_SPREAD): $(BENCHMARKS_DIRECTORY)/sssp.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(DEFINES_SPREAD) $(CFLAGS)

$(BIN_DIRECTORY)/sssp$(SUFFIX_SINGLE_BROADCAST): $(BENCHMARKS_DIRECTORY)/sssp.c
	$(CC) -o $@ $^ -I$(SRC_DIRECTORY) $(DEFINES) $(DEFINES_SINGLE_BROADCAST) $(CFLAGS)

$(BIN_DIRECTORY)/sssp$(SUFFIX_SINGLE_BROADCAST)$(SUFFIX_SPREAD): $(BENCHMARKS_DIRECTORY)/sssp.c
